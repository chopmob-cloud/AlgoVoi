...
function SwapForm({
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {executing && isWC && (
        <div className="flex items-center gap-2 bg-purple-500/10 border border-purple-500/20 rounded-lg px-3 py-2.5">
          <div className="w-3 h-3 border-2 border-purple-400 border-t-transparent rounded-full animate-spin flex-shrink-0" />
          <p className="text-xs text-purple-300">
            Check your phone — approve the swap in your wallet app.
          </p>
        </div>
      )}
